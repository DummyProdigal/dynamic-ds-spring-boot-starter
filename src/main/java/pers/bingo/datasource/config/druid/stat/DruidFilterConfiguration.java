...
public class DruidFilterConfiguration {
    ...
    private static final String FILTER_STAT_PREFIX = "spring.ds.dynamic.druid.filter.stat";
    private static final String FILTER_CONFIG_PREFIX = "spring.ds.dynamic.druid.filter.config";
    private static final String FILTER_ENCODING_PREFIX = "spring.ds.dynamic.druid.filter.encoding";
    private static final String FILTER_SLF4J_PREFIX = "spring.ds.dynamic.druid.filter.slf4j";
    private static final String FILTER_LOG4J_PREFIX = "spring.ds.dynamic.druid.filter.log4j";
    private static final String FILTER_LOG4J2_PREFIX = "spring.ds.dynamic.druid.filter.log4j2";
    private static final String FILTER_COMMONS_LOG_PREFIX = "spring.ds.dynamic.druid.filter.commons-log";
    private static final String FILTER_WALL_PREFIX = "spring.ds.dynamic.druid.filter.wall";
